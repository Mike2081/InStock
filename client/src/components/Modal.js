...
class Modal extends Component {
	...
	validate = () => {
		...
		const validation = Object.keys(fields).reduce(
			(a, c) => (fields[c].isValid ? ++a : a),
			0
		);
		if (validation === 9) {
			this.setState({
			...
			<div style={{ ...flex(isOpen) }}>
				...
				<div className='form-container'>
					<button
						...
						<img
							className='form-container__close-icon'
							src='/Assets/Icons/Close.svg'
							alt='Close button'
						/>
						<span className='form-container__close-text'>close</span>
					</button>
					<h2 className='form-container__header'>Add a new storage location</h2>
					<form
						...
						<div className='form-container__info'>
							<div className='form-container__sub-info'>
								...
								<label className='form-container__label'>
									<span className='form-container__label-header'>Country</span>
									<select
										type='country'
							...
							<div className='form-container__sub-info'>
								...
								<label className='form-container__label'>
									...
									{!inventoryType.isValid && submited && (
										<span className='form-container__input-error'>
						...
						<button
							...
							className='form-container__save-location'
							type='submit'>
							Save location
						</button>
					</form>
