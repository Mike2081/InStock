...
export default class InventoryItem extends Component {
	...
	componentDidMount() {
		fetch(`/inventory/${this.props.match.params.id}`)
	...
	render() {
		...
		return (
			<div className='InventoryItem' id={invItem.id}>
				<button onClick={() => this.goBack()} className='InventoryItem__link'>
					<img
						className='InventoryItem__backIcon'
				...
				<div className='InventoryItem__card'>
					...
					<div className='InventoryItem__productSummary'>
						...
						<div className='InventoryItem__info'>
							<span className='InventoryItem__infoTitle'>Last Ordered:</span>
